...
class FeatureSelectStep extends WizardPage<NewProjectConfig> {
    readonly title: string = nls.localize('oniro/newProjectWizard/FeatureSelectTitle', 'Manage Run-Time-Environment')
    ...
    render(configObject: NewProjectConfig): React.ReactNode {
        ...
        return <div>
            <table>
                <thead>
                    <tr><th></th><th>Vaiant</th><th>Version</th><th>Description</th></tr>
                </thead>
                <tbody>
